      ...
      <body>
        ...
        <form method="POST" action="{{route('branches.update',['branche' => $branche->id])}}">
            ...
            <div class="mb-3">
                ...
                disabled="disable" value="{{$branche->id}}">
                <div id="idHelp" class="form-text">Branches Id</div>
              </div>
    
              <div class="mb-3">
                <label for="name" class="form-label">Name</label>
                <input type="text" class="form-control" id="name" aria-describedby="nameHelp" 
                name="name" placeholder="Branche name" value="{{$branche->name}}">
              </div>
    
              <div class="mb-3">
                <label for="address" class="form-label">Address</label>
                <input type="text" class="form-control" id="address" aria-describedby="addresseHelp" 
                name="address" placeholder="Branche address" value="{{$branche->address}}">
              </div>
